...
open class ChartERView: UIView {
    ...
    var mainColor: CGColor = UIColor(red: 36/255, green: 138/255, blue: 1, alpha: 1).cgColor
    /// 보조 색상
    var subColor: CGColor = UIColor(red: 36/255, green: 138/255, blue: 1, alpha: 1).cgColor
    /// 축 색상
    var axisColor: CGColor = UIColor(red: 0.4, green: 0.4, blue: 0.4, alpha: 1).cgColor
    ...
    private func updateXAxisLabel() {
        for visibleIndex in 0 ..< xAxisLabels.count {
            if currentIndex + visibleIndex < xAxisNames.count {
